                                    ...
                                    <div className="space-y-6">
                                        {[1, 2].map((i) => (
                                            <div key={i} className="flex gap-4">
                                                ...
                                                <div>
                                                    <h4 className="font-bold text-sm text-gray-900 dark:text-white">Student {i} <span className="text-xs text-gray-500 font-normal ml-2">2 days ago</span></h4>
                                                    <p className="text-sm text-gray-700 dark:text-gray-300 mt-1 mb-2">Can you clarify the concept discussed around the 5-minute mark?</p>

                                                    {i === 1 && (
                                                        <div className="flex gap-4 mt-4 bg-gray-50 dark:bg-gray-900/50 p-4 rounded-lg border border-gray-200 dark:border-gray-800">
                                                            ...
                                                            <div>
                                                                <h4 className="font-bold text-sm text-indigo-600 dark:text-indigo-400">{course.profiles?.full_name || 'Instructor'} <span className="bg-indigo-100 dark:bg-indigo-900/50 text-indigo-700 dark:text-indigo-300 text-[10px] px-2 py-0.5 rounded ml-2">Instructor</span></h4>
                                                                <p className="text-sm text-gray-700 dark:text-gray-300 mt-1">Sure! At that point, we are actually demonstrating a edge case where the standard approach fails...</p>
                                                            </div>
                                                        </div>
                                                    )}
                                                </div>
